...
- **T1053.003 — Scheduled Task/Job: Cron**
  - Telegram: modifications to user crontab; new jobs running frequently with redirected output
  - Controls: restrict cron usage; alert on new crontab entries; auditd process monitoring

### Command and Control
- **T1071.001 — Application Layer Protocol: Web Protocols**
  - Telegram: periodic HTTP POSTs to uncommon destinations; jitter-like periodicity
...
- **T1027 — Obfuscated/Compressed Files and Information**
  - Telegram: base64 blobs; XOR-like patterns; unusual encoded payloads
